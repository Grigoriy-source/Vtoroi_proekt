...
class UrTube:
    ...
    def watch_video(self, title: str):
        '''Воспроизведение видео по названию с точным совпадением'''
    ...
    def get_video(self, title: str):
        '''Возвращает Video по названию или None, если его нет'''
    ...
    def get_user(self, nickname: str):
        '''Возвращает User по имени или None, если его нет'''
